        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur-md rounded-lg shadow-lg mt-2 p-4">
            <nav className="flex flex-col space-y-4">
              ...
              <Link
                to="/donate"
                className="text-xl font-extrabold bg-gradient-to-r from-blue-600 to-teal-600 text-white text-center px-6 py-2 rounded-full hover:from-blue-700 hover:to-teal-700 transition-all duration-200 mt-4"
                >
                Donate
              </Link>
            </nav>
